            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 flex flex-col items-center text-center">
                ...
                >
                    <h1 className="text-4xl md:text-6xl lg:text-9xl font-bold font-heading text-white leading-tight tracking-tighter">
                        ...
                        <div className="relative inline-block text-3d-massive-sm md:text-3d-massive text-white md:bg-clip-text md:text-transparent md:bg-full-spectrum animate-float leading-snug drop-shadow-md md:drop-shadow-none">
                            DEEPTHI P KUMAR
                        </div>
                    </h1>
                </motion.div>
